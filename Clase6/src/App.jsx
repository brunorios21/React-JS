...
// IMPORTAR EL FORMULARIO CONTENEDOR
// FormularioContainer es el componente inteligente que gestiona la lógica del formulario
  ...
  return (
    ...
    <Layout>
      ...
      */}
      ...
      {/*
        COMPONENTE FormularioContainer (CLASE 6)
        
        Este componente:
        1. Maneja el estado del formulario (nombre, precio, stock)
        2. Captura archivos de imagen seleccionados
        3. Sube la imagen a Imgbb (servicio externo)
        4. Combina todos los datos (formulario + imagen) y muestra en consola
        
        El patrón Contenedor/Presentacional está siendo utilizado aquí:
        - FormularioContainer: Lógica (el cerebro)
        - FormularioProducto: Presentación (la interfaz visual)
      */}
      <FormularioContainer />
    </Layout>
  );
